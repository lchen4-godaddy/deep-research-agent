...
COORDINATOR_AGENT_PROMPT = """
    ...
    2. Use the tool get_state with appropriate parameter to inform handoff decision-making.
        ...
        - If get_state("plan_finalized") returns False, handoff to the Planner Agent to review the plan. EXCEPT:
            - If the user is SPECIFICALLY confirming a generated research plan is to their liking, then set "plan_finalized" to True.
...
async def get_state(state: str) -> bool:
    ...
    Args:
        state: str - the state to get (has_enough_context, plan_generated, plan_finalized, research_finished, report_generated)
    """
